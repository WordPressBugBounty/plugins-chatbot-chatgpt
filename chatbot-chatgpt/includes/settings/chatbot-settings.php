...
function chatbot_chatgpt_settings_page() {
    ...
    if ( isset( $_GET['settings-updated'] ) && $_GET['settings-updated'] ) {
        add_settings_error(
            'chatbot_chatgpt_messages',
            'chatbot_chatgpt_message',
            'Settings Saved',
            'updated'
        );
    ...
    <div id="chatbot-chatgpt-settings" class="wrap">
       ...
       <h2 class="nav-tab-wrapper">
            <a href="?page=chatbot-chatgpt&tab=general" class="nav-tab <?php 
    echo ( $active_tab == 'general' ? 'nav-tab-active' : '' );
    ?>">General</a>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'OpenAI' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_chatgpt" class="nav-tab <?php 
        echo ( $active_tab == 'api_chatgpt' ? 'nav-tab-active' : '' );
        ?>">API/ChatGPT</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'OpenAI' ) {
        ?><a href="?page=chatbot-chatgpt&tab=gpt_assistants" class="nav-tab <?php 
        echo ( $active_tab == 'gpt_assistants' ? 'nav-tab-active' : '' );
        ?>">GPT Assistants</a>  <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'NVIDIA' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_nvidia" class="nav-tab <?php 
        echo ( $active_tab == 'api_nvidia' ? 'nav-tab-active' : '' );
        ?>">API/NVIDIA</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Anthropic' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_anthropic" class="nav-tab <?php 
        echo ( $active_tab == 'api_anthropic' ? 'nav-tab-active' : '' );
        ?>">API/Anthropic</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'DeepSeek' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_deepseek" class="nav-tab <?php 
        echo ( $active_tab == 'api_deepseek' ? 'nav-tab-active' : '' );
        ?>">API/DeepSeek</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Mistral' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_mistral" class="nav-tab <?php 
        echo ( $active_tab == 'api_mistral' ? 'nav-tab-active' : '' );
        ?>">API/Mistral</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Mistral' ) {
        ?><a href="?page=chatbot-chatgpt&tab=mistral_agent" class="nav-tab <?php 
        echo ( $active_tab == 'mistral_agent' ? 'nav-tab-active' : '' );
        ?>">Mistral Agent</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Local Server' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_local" class="nav-tab <?php 
        echo ( $active_tab == 'api_local' ? 'nav-tab-active' : '' );
        ?>">API/Local</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Markov Chain' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_markov" class="nav-tab <?php 
        echo ( $active_tab == 'api_markov' ? 'nav-tab-active' : '' );
        ?>">API/Markov</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Transformer' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_transformer" class="nav-tab <?php 
        echo ( $active_tab == 'api_transformer' ? 'nav-tab-active' : '' );
        ?>">API/Transformer</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Azure OpenAI' ) {
        ?><a href="?page=chatbot-chatgpt&tab=api_azure" class="nav-tab <?php 
        echo ( $active_tab == 'api_azure' ? 'nav-tab-active' : '' );
        ?>">API/Azure OpenAI</a> <?php 
    }
    ?>
            <?php 
    if ( esc_attr( get_option( 'chatbot_ai_platform_choice', 'OpenAI' ) ) == 'Azure OpenAI' ) {
        ?><a href="?page=chatbot-chatgpt&tab=gpt_azure_assistants" class="nav-tab <?php 
        echo ( $active_tab == 'gpt_azure_assistants' ? 'nav-tab-active' : '' );
        ?>">GPT Assistants</a>  <?php 
    }
    ?>
            <a href="?page=chatbot-chatgpt&tab=avatar" class="nav-tab <?php 
    echo ( $active_tab == 'avatar' ? 'nav-tab-active' : '' );
    ?>">Avatars</a>
            <a href="?page=chatbot-chatgpt&tab=appearance" class="nav-tab <?php 
    echo ( $active_tab == 'appearance' ? 'nav-tab-active' : '' );
    ?>">Appearance</a>
            <a href="?page=chatbot-chatgpt&tab=custom_buttons" class="nav-tab <?php 
    echo ( $active_tab == 'custom_buttons' ? 'nav-tab-active' : '' );
    ?>">Buttons</a>
            <a href="?page=chatbot-chatgpt&tab=kn_acquire" class="nav-tab <?php 
    echo ( $active_tab == 'kn_acquire' ? 'nav-tab-active' : '' );
    ?>">Knowledge Navigator</a>
            <a href="?page=chatbot-chatgpt&tab=reporting" class="nav-tab <?php 
    echo ( $active_tab == 'reporting' ? 'nav-tab-active' : '' );
    ?>">Reporting</a>
            <a href="?page=chatbot-chatgpt&tab=analytics" class="nav-tab <?php 
    echo ( $active_tab == 'analytics' ? 'nav-tab-active' : '' );
    ?>">Analytics</a>
            <a href="?page=chatbot-chatgpt&tab=tools" class="nav-tab <?php 
    echo ( $active_tab == 'tools' ? 'nav-tab-active' : '' );
    ?>">Tools</a>
            <a href="?page=chatbot-chatgpt&tab=diagnostics" class="nav-tab <?php 
    echo ( $active_tab == 'diagnostics' ? 'nav-tab-active' : '' );
    ?>">Messages</a>
            <a href="?page=chatbot-chatgpt&tab=support" class="nav-tab <?php 
