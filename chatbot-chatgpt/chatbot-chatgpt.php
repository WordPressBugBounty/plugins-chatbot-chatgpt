...
if ( function_exists( 'chatbot_chatgpt_freemius' ) ) {
    ...
    // STT API - Ver 2.0.1
    require_once plugin_dir_path( __FILE__ ) . 'includes/chatbot-call-openai-api-tts-api.php';
    // TTS API - Ver 1.9.4
    ...
    if ( function_exists( 'chatbot_chatgpt_freemius' ) && chatbot_chatgpt_freemius()->can_use_premium_code__premium_only() && chatbot_chatgpt_freemius()->is_plan( 'Premium' ) ) {
        ...
        add_action( 'admin_init', function () {
            if ( isset( $_POST['chatbot_chatgpt_analytics_action'] ) && $_POST['chatbot_chatgpt_analytics_action'] === 'period_filter' && isset( $_POST['chatbot_chatgpt_analytics_period_filter_nonce'] ) && wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['chatbot_chatgpt_analytics_period_filter_nonce'] ) ), 'chatbot_chatgpt_analytics_period_filter_action' ) ) {
                ...
                $selected_period = ( isset( $_POST['chatbot_chatgpt_analytics_period_filter'] ) ? sanitize_text_field( wp_unslash( $_POST['chatbot_chatgpt_analytics_period_filter'] ) ) : 'Today' );
    ...
    // For logged-out users, if needed
    ...
    add_action( 'wp_ajax_nopriv_chatbot_chatgpt_reset_all_locks', 'chatbot_chatgpt_reset_all_locks_handler' );
    // For logged-out users, if needed
